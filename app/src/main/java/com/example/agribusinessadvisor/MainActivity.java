...
public class MainActivity extends AppCompatActivity {
    ...
    CardView region1,region2,region3,region4,region5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        region4=findViewById(R.id.region4);
     
        setSupportActionBar(binding.appBarMain.toolbar);

        region5=findViewById(R.id.region5);
...
*/
        ...
        region1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
              ...
              //  Toast.makeText(MainActivity.this, "mushroom clicked ", Toast.LENGTH_SHORT).show();
                ...
                Intent intent =new Intent(MainActivity.this,CropCategoryActivity.class);
                startActivity(intent);
            }
        });
        ...
        region4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        region5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
